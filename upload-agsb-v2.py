...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "kim"         # 用户名
UUID = "6ddc3ef9-e84c-43cc-8204-e49cd3e0cf6c"                     # UUID，留空则自动生成
PORT = 19999                   # Vmess端口，留空或0则自动生成
DOMAIN = "ussl.flyme.pp.ua"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiYmFkOWE3MGY4NjdhZGYyMGYzZmY4ZDgzMDM2ZDEyMjYiLCJ0IjoiMWQwM2FlOWMtNmI3Yy00ZGZmLTkzMzctNTY2YTJjMWRkMjdkIiwicyI6Ik5EQTFOR0V6WWpZdFkyVTNaaTAwTURFeUxUazFOR010TldVM09EaGpOR1ptWldJeiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
